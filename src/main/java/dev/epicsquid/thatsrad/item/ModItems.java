package dev.epicsquid.thatsrad.item;
...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, ThatsRad.ID);

//Ooohh, add me harder, Item addion
    //Yes thiss includes Spawn Eggs
        //yes i got bored here
